...
.hr-a2ui__text[data-variant='caption'] { color: var(--hr-text-3); font-size: 12px; }
...
.hr-a2ui__audio-player figcaption { color: var(--hr-text-3); font-size: 12px; }
...
.hr-a2ui__tab-list button[aria-selected='true'] { border-color: var(--hr-accent); color: var(--hr-text-1); }
...
.hr-a2ui__divider[data-axis='vertical'] { width: 1px; min-height: 24px; border-top: 0; border-left: 1px solid var(--hr-border); }
...
.hr-a2ui__button[data-variant='primary'] > button { border-color: var(--hr-accent-border); background: var(--hr-accent-soft); }
.hr-a2ui__button[data-variant='borderless'] > button { border-color: transparent; color: var(--hr-accent); background: transparent; }
...
.hr-a2ui__validation { color: var(--hr-danger); font-size: 11px; line-height: 1.35; }
...
.homerail-a2ui [data-tone='warning'] { --tone: var(--hr-warning); }
.homerail-a2ui [data-tone='critical'] { --tone: var(--hr-danger); }
.homerail-a2ui [data-tone='neutral'] { --tone: var(--hr-text-3); }
...
.hr-a2ui__metric {
  ...
  border-radius: 7px;
  padding: 12px 14px;
  background: color-mix(in srgb, var(--tone) 8%, var(--hr-surface-1));
}
.hr-a2ui__metric span { color: var(--hr-text-3); font-size: 12px; }
.hr-a2ui__metric strong { margin-top: 4px; color: var(--hr-text-1); font-size: 28px; }
.hr-a2ui__metric small { margin-left: 5px; color: var(--hr-text-3); font-size: 11px; }
...
.hr-a2ui__status-badge {
  ...
  overflow-wrap: anywhere;
  color: var(--tone);
  background: color-mix(in srgb, var(--tone) 10%, var(--hr-surface-1));
  font-size: 11px;
  font-weight: 800;
}

.hr-a2ui__progress { display: grid; gap: 9px; }
.hr-a2ui__progress > header { display: flex; justify-content: space-between; gap: 10px; color: var(--hr-text-2); font-size: 12px; }
.hr-a2ui__progress-track { height: 7px; overflow: hidden; border-radius: 999px; background: var(--hr-border); }
...
.hr-a2ui__step-rail::after {
  ...
  width: 2px;
  content: '';
  background: color-mix(in srgb, var(--tone) 45%, var(--hr-border));
}
...
.hr-a2ui__step-rail > span {
  ...
  height: 30px;
  place-items: center;
  border: 1px solid color-mix(in srgb, var(--tone) 68%, var(--hr-border-strong));
  border-radius: 7px;
  color: var(--tone);
  background: var(--hr-panel);
  font-size: 12px;
...
.hr-a2ui__step-content > header strong { color: var(--hr-text-1); font-size: 15px; }
.hr-a2ui__step-content > header small { overflow: hidden; color: var(--hr-text-3); font-size: 11px; text-overflow: ellipsis; white-space: nowrap; }
...
.hr-a2ui__list li { display: grid; grid-template-columns: auto minmax(0, 1fr) auto; gap: 10px; align-items: center; border-bottom: 1px solid var(--hr-border); padding: 10px 1px; }
.hr-a2ui__list li > i { width: 8px; height: 8px; border-radius: 999px; background: var(--tone, var(--hr-text-3)); }
.hr-a2ui__list strong,
.hr-a2ui__list p { margin: 0; }
.hr-a2ui__list strong { font-size: 14px; }
.hr-a2ui__list p { margin-top: 3px; color: var(--hr-text-3); font-size: 12px; }
.hr-a2ui__list li > span { border-radius: 999px; padding: 4px 7px; color: var(--hr-text-3); background: var(--hr-surface-1); font-size: 10px; }
...
div.hr-a2ui__table { overflow-x: auto; overflow-y: visible; border: 1px solid var(--hr-border); border-radius: 7px; }
.hr-a2ui__table th,
.hr-a2ui__table td { padding: 11px 12px; border-bottom: 1px solid var(--hr-border); text-align: left; white-space: nowrap; }
.hr-a2ui__table th { color: var(--hr-accent); font-size: 11px; text-transform: uppercase; }
.hr-a2ui__table td { color: var(--hr-text-2); }
...
.hr-a2ui__timeline li > i { grid-row: 1 / span 2; width: 10px; height: 10px; margin-top: 4px; border: 2px solid var(--tone, var(--hr-text-3)); border-radius: 999px; }
.hr-a2ui__timeline time { color: var(--hr-text-3); font-size: 10px; }
.hr-a2ui__timeline strong { font-size: 14px; }
.hr-a2ui__timeline p { margin: 4px 0 0; color: var(--hr-text-3); font-size: 12px; }
...
.hr-a2ui__bar-chart > div > i { height: 7px; overflow: hidden; border-radius: 999px; background: var(--hr-border); }
.hr-a2ui__bar-chart > div > i b { display: block; height: 100%; border-radius: inherit; background: var(--tone, var(--hr-accent)); }

.hr-a2ui__disclosure { border-top: 1px solid var(--hr-border); padding-top: 10px; }
.hr-a2ui__disclosure summary { color: var(--hr-text-1); font-size: 13px; font-weight: 800; cursor: pointer; }
...
.hr-a2ui__link > small { grid-column: 1; overflow: hidden; color: var(--hr-text-3); text-overflow: ellipsis; white-space: nowrap; }
.hr-a2ui__link > svg { grid-column: 2; grid-row: 1 / span 2; transition: transform 0.18s ease; }
.hr-a2ui__link:hover { border-color: var(--hr-accent-border); background: var(--hr-accent-soft); }
.hr-a2ui__link:hover > svg { transform: translateX(2px); }
.hr-a2ui__link[data-unavailable='true'] { color: var(--hr-text-3); }
...
.hr-a2ui__dag-scroll {
  ...
  border: 1px solid var(--hr-border);
  border-radius: 7px;
  background-image: linear-gradient(var(--hr-surface-1) 1px, transparent 1px), linear-gradient(90deg, var(--hr-surface-1) 1px, transparent 1px);
  background-size: 24px 24px;
}
.hr-a2ui__dag { position: relative; }
.hr-a2ui__dag > svg { position: absolute; inset: 0; width: 100%; height: 100%; }
.hr-a2ui__dag > svg > path { fill: none; stroke: var(--hr-border-strong); stroke-width: 1.5; stroke-dasharray: 5 5; animation: hr-a2ui-edge 1.5s linear infinite; }
.hr-a2ui__dag marker path { fill: var(--hr-text-3); }
.hr-a2ui__dag-node { position: absolute; display: grid; grid-template-columns: auto minmax(0, 1fr); gap: 7px; align-content: center; border: 1px solid color-mix(in srgb, var(--tone) 45%, var(--hr-border)); border-radius: 7px; padding: 10px 11px 13px; background: var(--hr-panel); }
...
.hr-a2ui__dag-node span { margin-top: 3px; color: var(--hr-text-3); font-size: 11px; }
.hr-a2ui__dag-node > i { position: absolute; right: 10px; bottom: 7px; left: 10px; height: 3px; overflow: hidden; background: var(--hr-border); }
