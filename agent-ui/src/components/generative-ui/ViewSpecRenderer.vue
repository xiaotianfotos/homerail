...
.hr-view__heading { margin:0; color:#f7ffff; line-height:1.16; letter-spacing:0; text-wrap:balance; }.hr-view__heading:is(h1) { font-size:32px; }.hr-view__heading:is(h2) { font-size:26px; }.hr-view__heading:is(h3) { font-size:19px; }
