  ...
  workflow_template: {
    ...
    spec: {
      ...
      nodes: {
        ...
        deterministic_check: { kind: "command", inputs: { challenge: { contract: "Challenge" }, repair: { contract: "Repair" } }, outputs: { passed: {}, failed: {} }, config: { input: "challenge", command_field: "test_command", timeout_ms: 120000, success_port: "passed", failure_port: "failed", parse_stdout: "text" } },
