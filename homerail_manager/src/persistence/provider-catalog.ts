...
export const DEFAULT_PROVIDER_CATALOG: CatalogProviderInfo[] = [
  ...
  },
  {
    ...
    docs_url: "https://novita.ai/docs/guides/llm-api",
    endpoints: [
      endpoint({
        id: "novita_api",
        provider_id: "novita",
        name: "Novita AI API 计费",
        plan_type: "api_billing",
        protocol: "openai_compatible",
        base_url: "https://api.novita.ai/openai",
        chat_completions_base_url: "https://api.novita.ai/openai",
        anthropic_base_url: "https://api.novita.ai/anthropic",
        auth_type: "bearer",
        key_hint: "Novita AI API Key",
        default_model: "deepseek/deepseek-v3.2-exp",
        docs_url: "https://novita.ai/docs/guides/llm-api",
        models: [
          model("deepseek/deepseek-v3.2-exp", {}, { recommended: true }),
