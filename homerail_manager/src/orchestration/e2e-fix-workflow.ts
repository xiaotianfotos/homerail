...
const plan = {
  ...
  properties: { strategy: text, allowed_paths: { type: "array", minItems: 1, maxItems: 20, items: text },
    blocked_reason: { ...text, description: "Optional explanation when the Planner cannot produce a useful plan within the authorized scope. Stops before Fixer; not a required causal-repair certification." } },
};
const patch = {
